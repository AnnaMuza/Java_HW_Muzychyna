package HW10.HW8_exception;
import java.lang.Math;
import java.util.*;


class PointException extends ArithmeticException {
...
class CircleException extends ArithmeticException {
    private String detail;

    CircleException(String message) {
        detail = message;
    }
...
class Point {
    ...
    public double distance_to_point(Point p) throws PointException {
    ...
    public double distance_to_origin() throws PointException {
...
class Circle {
    ...
    Circle(double a, double b, double r) throws PointException, CircleException {
        if (r == 0) throw new CircleException("Radius cannot be zero!");
    ...
    @Override
    public String toString() {
        return String.format("Circle((%.2f, %.2f), r=%.2f)", center.a, center.b, radius);
    }
}


// Вспомогательный класс без обработки ошибок
class Line {
